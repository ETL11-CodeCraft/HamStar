...
public class FeedingManager : MonoBehaviour
{
    ...
    [SerializeField] GameObject _feedPanel_darkModeWarning;  //흑화모드 시 경고패널
    ...
    private void Awake()
    {
        ...
        onPointerDownEntry_seed.callback.AddListener(eventData =>
        {
            ...
            GameManager.instance.ReduceCount(10001);  //10001번의 아이템 개수 1 감소
        });
        ...
        onPointerDownEntry_goldseed.callback.AddListener(eventData =>
        {
            ...
            GameManager.instance.ReduceCount(10002);  //id : 10002번의 아이템 개수 줄이기 
        });
